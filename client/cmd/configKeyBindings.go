...
var getKeyBindingsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("toggle-default-filter: \t" + strings.Join(config.KeyBindings.ToggleDefaultFilter, " "))
	},
}
...
var setKeyBindingsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		case "toggle-default-filter":
			config.KeyBindings.ToggleDefaultFilter = args[1:]
		default:
